...
mod tests {
    ...
    fn from_relative_offset() {
        // input is relative to 2001-02-03T04:05:06
        for (input, expect) in &[
            ("-1s", Date::from_abs("2001-02-03T04:05:05")),
            ("0s", Date::from_abs("2001-02-03T04:05:06")),
            ("1s", Date::from_abs("2001-02-03T04:05:07")),
            ("59s", Date::from_abs("2001-02-03T04:06:05")),
            ("-1m", Date::from_abs("2001-02-03T04:04:06")),
            ("0m", Date::from_abs("2001-02-03T04:05:06")),
            ("1m", Date::from_abs("2001-02-03T04:06:06")),
            ("59m", Date::from_abs("2001-02-03T05:04:06")),
            ("-1h", Date::from_abs("2001-02-03T03:05:06")),
            ("0h", Date::from_abs("2001-02-03T04:05:06")),
            ("1h", Date::from_abs("2001-02-03T05:05:06")),
            ("23h", Date::from_abs("2001-02-04T03:05:06")),
            ("-1d", Date::from_abs("2001-02-02T04:05:06")),
            ("0d", Date::from_abs("2001-02-03T04:05:06")),
            ("1d", Date::from_abs("2001-02-04T04:05:06")),
            ("27d", Date::from_abs("2001-03-02T04:05:06")),
            ("-1w", Date::from_abs("2001-01-27T04:05:06")),
            ("0w", Date::from_abs("2001-02-03T04:05:06")),
            ("1w", Date::from_abs("2001-02-10T04:05:06")),
            ("52w", Date::from_abs("2002-02-02T04:05:06")),
            ("-1M", Date::from_abs("2001-01-03T04:05:06")),
            ("0M", Date::from_abs("2001-02-03T04:05:06")),
            ("1M", Date::from_abs("2001-03-03T04:05:06")),
            ("11M", Date::from_abs("2002-01-03T04:05:06")),
            ("-1y", Date::from_abs("2000-02-03T04:05:06")),
            ("0y", Date::from_abs("2001-02-03T04:05:06")),
            ("1y", Date::from_abs("2002-02-03T04:05:06")),
            ("10y", Date::from_abs("2011-02-03T04:05:06")),
            // unhappy path
            ("1x", None),
        ] {
            let rel_input = Date::from_rel(input, &test_now());
